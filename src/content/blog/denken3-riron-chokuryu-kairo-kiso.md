...
<p style="font-size:0.88rem;color:var(--text-muted);margin:0 0 0.9rem;line-height:1.7;">直流回路の基本は分かっても、複雑な回路になると手が止まることがあります。電験三種に特化したオンライン講座「資格合格支援スクール【能セン】」で、演習量を確保するのもおすすめです。</p>
